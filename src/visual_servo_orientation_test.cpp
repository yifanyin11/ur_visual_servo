...
int main(int argc, char** argv){
    ...
    // visual_servo::ToolDetector detector_ori_cam1(nh, std::vector<int>{103, 220, 140, 109, 255, 179}); // blue night
    ...
    visual_servo::VisualServoController servo_controller(nh, t_topic, 5, 0.001);
    ...
    std::vector<visual_servo::ToolDetector> detector_list{detector_tool_cam1, detector_tool_cam2, detector_ori_cam1, detector_ori_cam2};
